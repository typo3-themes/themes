...
class LanguageMenuViewHelper extends AbstractViewHelper
{
     ...
     */
    protected LanguageMenuController $controller;
    ...
    public function initializeArguments()
    {
        ...
        $this->registerArgument(
            'availableLanguages',
            'string',
            'Comma separated list of integers of the languages',
            false,
            ''
        );
        $this->registerArgument('currentLanguageUid', 'int', 'Id of the current language', false, 0);
        $this->registerArgument(
            'defaultLanguageIsoCodeShort',
            'string',
            'IsoCode of the default language',
            false,
            'en'
        );
        ...
        $this->registerArgument(
            'flagIconPath',
            'string',
            'directory containing the flags',
            false,
            '/typo3/sysext/core/Resources/Public/Icons/Flags/SVG/'
        );
